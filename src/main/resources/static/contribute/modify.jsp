...
<%@page	import="es.elearningmedia.equella.data.WrappedContent" %>
<%@page	import="es.elearningmedia.equella.common.BbUtil" %>
...
<tle:context>
	...
	<bbng:learningSystemPage title="Modify EQUELLA Content">
		...
		<form name="the_form" action="modify_proc.jsp" method="post">
			<input type="hidden" name="<%=es.elearningmedia.equella.common.BbUtil.CONTENT_ID%>" value="<%=content.getId().toExternalString()%>">
			<input type="hidden" name="<%=es.elearningmedia.equella.common.BbUtil.COURSE_ID%>" value="<%=content.getCourse().getId().toExternalString()%>">
